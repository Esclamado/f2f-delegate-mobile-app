...
@Component({
  selector: 'app-note-send-mail-enhance',
  templateUrl: './note-send-mail-enhance.page.html',
  styleUrls: ['./note-send-mail-enhance.page.scss'],
})
export class NoteSendMailEnhancePage implements OnInit {
