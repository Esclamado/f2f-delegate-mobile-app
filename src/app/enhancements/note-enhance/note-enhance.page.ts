...
@Component({
  selector: 'app-note-enhance',
  templateUrl: './note-enhance.page.html',
  styleUrls: ['./note-enhance.page.scss'],
})
export class NoteEnhancePage implements OnInit {
  ...
  deleteNote(){
    ...
    .subscribe(r => {
      if(r.error == 0){
        this.noteService.env.redirect('/event-notes-enhance/' + this.event_id);
      }
